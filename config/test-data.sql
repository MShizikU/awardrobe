INSERT INTO users (hashcode, is_disposable, status, email, phone, password, role_id) VALUES
    ('abcd1234', false, 'active', 'ADMIN@example.com', NULL, 'hashed_password', 1),
    ('xyz9876', false, 'active', 'MANAGER@example.com', NULL, 'hashed_password', 2),
    ('uvw5678', false, 'active', 'OBSERVER@example.com', NULL, 'hashed_password', 3),
    ('qwe1234', false, 'active', 'EXECUTOR@example.com', NULL, 'hashed_password', 4),
    ('rty1234', false, 'active', 'USER@example.com', NULL, 'hashed_password', 5);
